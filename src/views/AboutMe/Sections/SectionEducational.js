...
import phhslogo from "assets/img/img/phhslogo.png";
import usclogo from "assets/img/img/usclogo.jpg";
              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>Computer Science and Business Administration</h5>
                        <p className={classes.cardDescriptionWhite}>
                          Dual-Degree
                        </p>
              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>Student</h5>
                        <p className={classes.cardDescriptionWhite}>
                            Incredibly stubborn, skeptical, and sleepy student.
                        </p>
                      </CardBody>
                    </div>
                  </Card>
