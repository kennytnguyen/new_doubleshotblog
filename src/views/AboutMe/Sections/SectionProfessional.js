              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>CEA Systems PM</h5>
                        <p className={classes.cardDescriptionWhite}>
                          Capacity Engineering and Analysis tooling to support capacity planning
                          and demand engineering processes.
                        </p>
                        <h5 className={classes.cardTitleWhite}>Service Capacity Deployment Lead</h5>
                        <p className={classes.cardDescriptionWhite}>
                        Program management support in operations, execution, and architectural 
                        / transformational changes within Data Centers.
                        </p>
                      </CardBody>
                    </div>
                  </Card>
              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>Strategic Partnerships and Integrations</h5>
                        <p className={classes.cardDescriptionWhite}>
                          Shipped Stringify and IFTTT integrations with Kasa's Smart Home platform into public beta.
                        </p>
              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>Digital Printing Infrastructure</h5>
                        <p className={classes.cardDescriptionWhite}>
                          Backend APIs
                        </p>
                      </CardBody>
              ...
              <GridItem xs={12} sm={6} md={6}>
                <div className={classes.rotatingCardContainer}>
                  <Card background className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        <h5 className={classes.cardTitleWhite}>System Design Engineering</h5>
                        <p className={classes.cardDescriptionWhite}>
                          3PAR Storage
                        </p>
                      </CardBody>
